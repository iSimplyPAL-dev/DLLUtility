...
namespace Utility
{
	...
	public class EncDec 	{ 
		...
		public string Crypt(string strToCrypt,string Password)
		{
			string cipherText;
			cipherText = Encrypt(strToCrypt, Password );
			return cipherText;

		}
		public string DeCrypt(string strToCrypt,string Password)
		{
			
			string decryptedText = Decrypt(strToCrypt, Password);	
